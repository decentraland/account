...
export interface RootChainManagerInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'childToRootToken', values: [string]): string
  ...
  encodeFunctionData(functionFragment: 'mapToken', values: [string, string, BytesLike]): string
  encodeFunctionData(functionFragment: 'processedExits', values: [BytesLike]): string
  encodeFunctionData(functionFragment: 'registerPredicate', values: [BytesLike, string]): string
  encodeFunctionData(functionFragment: 'remapToken', values: [string, string, BytesLike]): string
  encodeFunctionData(functionFragment: 'renounceRole', values: [BytesLike, string]): string
  encodeFunctionData(functionFragment: 'revokeRole', values: [BytesLike, string]): string
  encodeFunctionData(functionFragment: 'rootToChildToken', values: [string]): string
  encodeFunctionData(functionFragment: 'setCheckpointManager', values: [string]): string
  encodeFunctionData(functionFragment: 'setChildChainManagerAddress', values: [string]): string
  encodeFunctionData(functionFragment: 'setStateSender', values: [string]): string
...
export type MetaTransactionExecutedEvent = TypedEvent<[string, string, string], MetaTransactionExecutedEventObject>
...
export type PredicateRegisteredEvent = TypedEvent<[string, string], PredicateRegisteredEventObject>

export type PredicateRegisteredEventFilter = TypedEventFilter<PredicateRegisteredEvent>
...
export type TokenMappedEvent = TypedEvent<[string, string, string], TokenMappedEventObject>
...
export interface RootChainManager extends BaseContract {
  ...
  functions: {
    ...
    depositEtherFor(user: string, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
    ...
    exit(inputData: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
    ...
    initializeEIP712(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
    ...
    setStateSender(newStateSender: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>

    setupContractId(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    mapToken(rootToken: string, childToken: string, tokenType: BytesLike, overrides?: CallOverrides): Promise<void>

    processedExits(arg0: BytesLike, overrides?: CallOverrides): Promise<boolean>

    registerPredicate(tokenType: BytesLike, predicateAddress: string, overrides?: CallOverrides): Promise<void>

    remapToken(rootToken: string, childToken: string, tokenType: BytesLike, overrides?: CallOverrides): Promise<void>
    ...
    setCheckpointManager(newCheckpointManager: string, overrides?: CallOverrides): Promise<void>

    setChildChainManagerAddress(newChildChainManager: string, overrides?: CallOverrides): Promise<void>

    setStateSender(newStateSender: string, overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    ...
    'PredicateRegistered(bytes32,address)'(tokenType?: BytesLike | null, predicateAddress?: string | null): PredicateRegisteredEventFilter
    PredicateRegistered(tokenType?: BytesLike | null, predicateAddress?: string | null): PredicateRegisteredEventFilter
    ...
    TokenMapped(rootToken?: string | null, childToken?: string | null, tokenType?: BytesLike | null): TokenMappedEventFilter
  }
  ...
  estimateGas: {
    ...
    childToRootToken(arg0: string, overrides?: CallOverrides): Promise<BigNumber>

    depositEtherFor(user: string, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    exit(inputData: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    initializeEIP712(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    rootToChildToken(arg0: string, overrides?: CallOverrides): Promise<BigNumber>

    setCheckpointManager(newCheckpointManager: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    setStateSender(newStateSender: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>

    setupContractId(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    typeToPredicate(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>
  }
  ...
  populateTransaction: {
    ...
    childToRootToken(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    depositEtherFor(user: string, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
    ...
    exit(inputData: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
    ...
    initializeEIP712(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
    ...
    rootToChildToken(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    setStateSender(newStateSender: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>

    setupContractId(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>

    stateSenderAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>

    tokenToType(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    typeToPredicate(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>
  }
}
