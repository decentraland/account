...
export const loginRequest = (restoreSession = false) =>
  action(LOGIN_REQUEST, { restoreSession })
export const loginSuccess = (wallet: Wallet, identity: AuthIdentity) =>
  action(LOGIN_SUCCESS, { wallet, identity })
...
export const destroyIdentity = (address: string) =>
  action(DESTROY_IDENTITY, { address })
