...
const mapDispatch = (dispatch: MapDispatch): MapDispatchProps => ({
  onPendingWithdrawal: txHash => dispatch(openModal('WithdrawalStatusModal', { txHash })),
  ...
  onPendingPurchase: (network, gateway) => dispatch(openManaFiatGatewayRequest(network, gateway))
})
